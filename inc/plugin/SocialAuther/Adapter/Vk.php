...
class Vk extends AbstractAdapter
{
    ...
    /**
     * Получить имя пользователя или NULL, если он не установлен
     *
     * @return string|null
     */
    ...
    /**
     * Получить пользовательский социальный идентификатор или нуль, если он не установлен
     *
     * @return string|null
     */
    ...
    /**
     * Получить пользовательский секс или нуль, если он не установлен
     *
     * @return string|null
     */
    ...
    /**
     *Аутентифицировать и возвращать результат аутентификации
     *
     * @return bool
     */
